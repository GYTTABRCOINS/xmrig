...
package com.semipool.apk.semiminer;
...
public class MiningService extends Service {
    ...
    public void onCreate() {
        ...
        Notification notification = new NotificationCompat.Builder(this, "my_channel_id_01")
                ...
                .setContentTitle("SemiMiner")
                .setContentText("the best real mining experience")
    ...
    private String fetchOrCreateWorkerId() {
        SharedPreferences preferences = getSharedPreferences("ETNMining", 0);
